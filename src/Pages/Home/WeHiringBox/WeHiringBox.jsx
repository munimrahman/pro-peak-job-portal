...
function WeHiringBox() {
    return (
        <div className="flex flex-col items-center sm:flex-row justify-around md:justify-center border rounded-md  max-w-[950px] mx-auto mt-14 hiring-box px-5 py-7 mb-5">
